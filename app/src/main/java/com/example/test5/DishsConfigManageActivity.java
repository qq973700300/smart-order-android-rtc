...
/** 管理员菜谱管理（对应上位机 XmlDishes）。 */
public class DishsConfigManageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new DishsConfigManageAdapter(item -> {
        });
    ...
    private void openEdit(String id) {
        Intent intent = new Intent(this, DishsConfigEditActivity.class);
        if (id != null) {
            intent.putExtra(DishsConfigEditActivity.EXTRA_ID, id);
        }
